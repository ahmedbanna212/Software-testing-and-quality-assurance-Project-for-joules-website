...
public class D_decrement {
	public static void main(String[] args) throws InterruptedException {
		//You must download chromedriver.exe for ChromeDriver to work properly
            ...
            //pressing the "-" button to decrement the item quantity
            driver.findElement(By.xpath("//*[@id=\"updateCartForm0\"]/input[4]")).click();
            ...
            if(driver.findElement(By.xpath("//*[@id=\"page\"]/div[5]/div[2]/div")).isDisplayed()==true){
                ...
                if(!(new_quantrity.equals(old_quantrity))){
                    ...
                    System.out.println("the quantity of the item got decreased");
